...
import { calculateProgress, calculateRemaining } from "../utils/timeUtils";
...
export default function MeditationSession() {
  ...
  const { isUnstable } = useMotionStability();
  ...
  const remaining = calculateRemaining(timer.elapsed, timer.roundSeconds);
  const progress = calculateProgress(timer.elapsed, timer.roundSeconds);
      ...
      <div className={styles.sessionLayout}>
        <button
          className={`${styles.sideBtn} ${
            !timer.canPrev ? styles.sideBtnHidden : ""
          }`}
          ...
          <div className={styles.orbWrap}>
            ...
            <div
              className={`${styles.orb} ${
                timer.isFinished ? styles.orbFinished : ""
              }`}
            >
        ...
        <button
          className={`${styles.sideBtn} ${
            !timer.canNext ? styles.sideBtnHidden : ""
          }`}
