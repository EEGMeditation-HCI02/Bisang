...
import styles from "./css/SettingGuidePage.module.css";
      ...
      <main className={styles.main}>
        ...
        <header className={styles.hero}>
          ...
          <p className={styles.heroDesc}>
            Achieving perfect brainwave synchronization begins with the right fit.
            Follow this brief guide to prepare your sanctuary for the session.
          </p>
        </header>
        ...
        <div className={styles.grid}>
          ...
          {/* Device card — col-span 7 */}
          <div className={`${styles.card} ${styles.cardDevice}`}>
            <div className={styles.cardDeviceInner}>
              <div>
                <span className={styles.badge}>The Device</span>
                <h2 className={styles.cardTitle}>Precision Engineering</h2>
                <p className={styles.cardText}>
                  Our minimalist headset uses medical-grade sensors to map your neural
                  rhythms with zero intrusive wires.
                </p>
              </div>
          ...
          {/* Step cards (01, 02) — col-span 5 each */}
          {STEPS.map((step) => (
            <div key={step.num} className={`${styles.card} ${styles.cardStep}`}>
          ...
          {/* Step 03 — col-span 7, horizontal layout */}
          <div className={`${styles.card} ${styles.cardEar}`}>
            <div className={styles.earText}>
              ...
              <p className={styles.stepDesc}>
                Finally, attach the grounding clip to your left earlobe. Ensure direct
                skin contact for the most accurate bio-feedback during your meditation session.
              </p>
            </div>
        ...
        <div className={styles.cta}>
          ...
          <div className={styles.ctaContent}>
            ...
            <p className={styles.ctaDesc}>
              Once fitted, the MindWave will automatically detect your signal strength
              and begin the calibration process.
            </p>
            <button className={styles.ctaBtn}>Start Your Session</button>
          </div>
        </div>
      </main>
    </div>
